...
In this task, you will import the **IoT Plug and Play CAT-G3** pre-configured device template.
...
1. Now on your application page, from the left-hand menu navigate to **Devices**.
...
1. Click on **Overview**. The **Overview** page shows a plot of the simulated telemetry. 
   ...
   > **Note**: It might take around 5 minutes for the data to appear.
