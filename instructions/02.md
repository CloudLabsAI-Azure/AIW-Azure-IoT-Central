...
1. If your solution requires finer-grained access controls, you can create custom roles with custom sets of permissions.

1. In **Administration** page select **Users**.
...
1. In the New user page enter the following and click on **save**.
   ...
   - **Email** 
       ...
       Enter the email id of new user
