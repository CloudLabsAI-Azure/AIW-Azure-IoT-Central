...
1. On the **When a rule is fired(Preview)** tab, select **Contoso-Connected logistics-Deployment-ID** as **Application** and **Temperature-Sensor-Alert** as **Rule**. Click on **+New step**.
...
1. In the **Execute a device command(preview)** page, select the following:
     ...
     - **Application**: Select **Contoso-Connected logistics-Deployment-ID**.
