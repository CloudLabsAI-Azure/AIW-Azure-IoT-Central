...
1. In **Device Dashboard** page, under **Telemetery**  select **Temperature** and click on **Add tile**. Click on **Save**.

1. Now in your connected logistics application page from the left hand navigation menu select **Devices**.

1. In the **Devices page** select **SN 100** device and in the device dashboard you can observe the newly added tempature tile and the temperature value.
