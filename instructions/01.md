...
In this task, you will create a connected logistics application using a built-in template from Azure portal for tracking the assets. 

**Note**: Due to the permission restrictions in the environment provided, you will be creating the application from the Microsoft Azure Portal instead of IoT Central portal. To create an application from the IoT Central portal you will need subscription level access. 
...
1. Now in IoT Central application resource page click on IoT Central application URL. This will redirect you to Connected Logistics application page.
...
You have already created an application from Azure portal in the previous steps so you will only be reading through the below steps to understand how you can create an application from the IoT Central portal. 
...
1. In the **Location** tile you can see all the routes that were taken in the past 30 minutes. Now click on the pinned icon in the location tile page, this will provide details on longitude, latitude, and time. When done, select **Back to dashboard view** to return to the dashboard.
...
1. In the **Logistics Gateway** page under views click on **Device Dashboard** from her you can configure your device dashboard.
...
1. Now in your connected logistics application page from the left hand navigation menu select **Devices** and in the **Devices page** select **SN 100** device.

   ![](media/img152.png)

1. In the SN 100 device page select **Device Dashboard**, from here you can observe the newly added tempature tile and the temperature values.
...
1. Now from your Connected logistics application page, from the left navigation menu select **Jobs**. 

1. In the **Jobs** page select **+ New job**.

    ![](media/img29.png)

1. On the **Configure your job page**, enter a name and description for your job. Then under the **Target devices** section, select the **Device group** as **Logistics Gateway - All devices**.
...
1. In the **Schedule** job page toggle the Enable option to **On** and enter the following details:
   ...
   - **Start**
     ...
     Under start you can set a start date and time for a scheduled job. The date and time is specific to your time zone, and not to the device's local time.
     
   - **End**
   
     To end a recurring schedule, you can choose **On this day** to set an end date for the schedule or **After** to set the number of times to run the job.
...
1. For now to run the job immediately, click on **Edit** in the job details page. 

    ![](media/img155.png)

1. In the job wizard navigate to schedule page and toggle the enable option to **Off**.
...
In this exercise, you have learned how to create an application from Azure IoT Central and explored through your application dashboard. You also learned to add the new device's in the application, created rules, configured jobs, and analyzed telemetry data.
