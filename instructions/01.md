...
1. Click on **Expand** icon, update the **Min value** to 70 and **Max value** to 90 then click on **Save**. 
...
1. In the **Device Dashboard** you can see the **Status** of your device, **Transportation mode**, **Battery life**, **Location** of the device, and **Tags**. It might take a few minutes for the data to appear.
...
1. Select **Next** to move to the **Schedule** page. The Schedule page lets you enable a schedule to run the job in the future, for now leave the values as default.
...
1. Click on **Save**. When the status shows Configured, you're ready to upload files from devices.
   ...
   > **Note**: We will not be showing how to upload files from a device. To learn about uploading files from a device refer to https://docs.microsoft.com/en-us/azure/iot-central/core/howto-configure-file-uploads#upload-a-file-from-a-device.
