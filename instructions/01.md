...
1. Now click on **Save** and in the top menu click on **Publish**.

1. Now in your connected logistics application page from the left hand navigation menu select **Devices**.

1. In the **Devices page** select **SN 100** device and in the device dashboard you can observe the newly added tempature tile and the temperature values.
