...
1. On **Sign in to Microsoft Azure** blade, you will see a login screen, the email/username and then click on **Next**. You can find the username from the environment details tab.
...
1. Explore through the different kinds of tiles displayed in the dashboard like **Location**, **Gateway state**, **Battery utilization**, **Multimodal transport**, and much more. 
   ...
   > **Note**: It might take 5-10 minutes for the data to appear.
